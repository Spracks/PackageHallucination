import webui_api_package_query_RAG_DG
import sys
...
##### mitigation measures, namely a combination of RAG and self-detection.
...
webui_api_package_query_RAG_DG.query_API(1,
...
webui_api_package_query_RAG_DG.query_API(2, f"{data_path}/Package_LY.json",
                                  f"{model_path}/{model_name}/Package_LY_packages_2.json",
                                  ip, port)
...
webui_api_package_query_RAG_DG.query_API(2, f"{data_path}/Package_AT.json",
                                  f"{model_path}/{model_name}/Package_AT_packages_2.json",
                                  ip, port)
...
webui_api_package_query_RAG_DG.query_API(2, f"{data_path}/SO_LY.json",
                                  f"{model_path}/{model_name}/SO_LY_packages_2.json",
                                  ip, port)
...
webui_api_package_query_RAG_DG.query_API(2, f"{data_path}/SO_AT.json",
                                  f"{model_path}/{model_name}/SO_AT_packages_2.json",
                                  ip, port)
